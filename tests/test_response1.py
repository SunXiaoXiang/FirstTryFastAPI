...
@pytest.mark.parametrize(
    ...
    [
        (
            {"username": "johndoe", "password": "secret", "email": "invalid_email"},
            422,
        ),  # 无效的电子邮件
        (
            {"username": "", "password": "secret", "email": "johndoe@example.com"},
            200,
        ),  # 空的用户名
        (
            {"username": "johndoe", "password": "", "email": "johndoe@example.com"},
            200,
        ),  # 空的密码
